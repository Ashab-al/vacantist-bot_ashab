...
@pytest.mark.asyncio
async def test_find_subscribe(session_factory):
    ...
    async with session_factory() as session:
        ...
        subscribes: list[Category] = await find_subscribe(
            session,
            user  
        )
...
@pytest.mark.asyncio
async def test_find_subscribe_when_user_is_not_exist(session_factory):
