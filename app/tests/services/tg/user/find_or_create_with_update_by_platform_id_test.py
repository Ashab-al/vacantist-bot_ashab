...
@pytest.mark.asyncio
async def test_find_or_create_creates_new_user(session_factory, mocker):
...
@pytest.mark.asyncio
async def test_find_or_create_returns_existing_user(session_factory, mocker):
...
@pytest.mark.asyncio
async def test_find_or_create_unblocks_user(session_factory, mocker):
