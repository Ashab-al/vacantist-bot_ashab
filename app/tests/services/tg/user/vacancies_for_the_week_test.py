...
@pytest.mark.asyncio
async def test_vacancies_for_the_week(session):
    ...
    result = await fetch_vacancies_for_the_week(session, user, PAGE, PAGE_SIZE)
...
@pytest.mark.asyncio
async def test_vacancies_for_the_week_when_has_not_subscribes(session):
