...
@pytest.mark.asyncio
async def test_update_subscription_with_category_when_user_has_subscribe(session):
...
@pytest.mark.asyncio
async def test_update_subscription_with_category_when_user_has_not_subscribe(session):
    """Проверка подписки / отписки на категорию.
