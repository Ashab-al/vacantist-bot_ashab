...
async def update_status(
    ...
    Args:
        ...
        user_id (SetStatusUserIdRequest): Идентификатор пользователя,
            у которого нужно изменить статус.
        bot_status (SetStatusRequest): Новое значение статуса пользователя.

    Raises:
        HTTPException: Возвращает ошибку 400, если передан некорректный статус
