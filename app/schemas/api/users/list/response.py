...
class UserResponse(CamelModel):
    ...
    Используется для возврата информации о пользователе, включая
    идентификаторы, контактные данные, поинты, статус в системе
    и список категорий.
    """
...
class ListUsersResponse(CamelModel):
    """
    Схема ответа API для возврата списка пользователей.

    Содержит коллекцию объектов `UserResponse`.
    """
